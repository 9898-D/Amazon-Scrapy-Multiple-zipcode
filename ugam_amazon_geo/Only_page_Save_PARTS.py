...
print("Choise-1", f"select Id from {Table_name} where page_save_status='Pending'")
...
bat_path = r'D:\Dhruv_Choubisa_Amazon_US_GEO\ugam_amazon_geo\ugam_amazon_geo\spiders\only_page_save.bat'
